  ...
  return (
    ...
    >
      <span style={{
        ...
        fontSize: '8px', cursor: 'help', fontFamily: 'DM Mono, monospace',
        lineHeight: '12px', userSelect: 'none',
      }}>
        i
      </span>
      {visible && (
        <span style={{
          ...
          fontFamily: 'DM Mono, monospace', fontSize: '10px', color: 'var(--cream)',
...
const TABLE_HEADERS: { label: string; desc?: string }[] = [
  { label: 'Task' },
  { label: 'Provider / Model' },
  { label: 'Calls',      desc: 'Number of API calls made to the LLM for this task' },
  { label: 'Prompt',     desc: 'Input tokens sent to the model (job description, resume, etc.)' },
  { label: 'Completion', desc: 'Output tokens generated by the model (the response)' },
  { label: 'Total',      desc: 'Total tokens = prompt + completion' },
  { label: 'Avg ms',     desc: 'Average response time per call including network latency' },
]
            ...
            return (
              <div key={date} style={{ ...CARD_STYLE, borderLeft: isToday ? '2px solid var(--yellow)' : '1px solid var(--border)' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr>
                      {TABLE_HEADERS.map(({ label, desc }) => (
                        <th key={label} style={{ textAlign: 'left', padding: '4px 8px', fontFamily: 'DM Mono, monospace', fontSize: '9px', fontWeight: 400, color: 'var(--text-muted)', borderBottom: '1px solid var(--border)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
                          {label}{desc && <InfoTooltip text={desc} />}
                        </th>
                      ))}
                    </tr>
                  </thead>
